...
$sModversion = "2001" ; Upgrade to MyBot v6.2.0
$sBotVersion = "v6.2.0" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it it also use on Checkversion()
